        ...
        try:
            ...
            for event in agent.run_stream(message):
                ...
                if event_type == "final":
                    ...
                    yield f"data: {json.dumps({'type': 'decision', 'step': step, 'content': content}, ensure_ascii=False)}\n\n"
                elif event_type == "termination":
                    yield f"data: {json.dumps({'type': 'termination', 'step': step, 'content': content}, ensure_ascii=False)}\n\n"
